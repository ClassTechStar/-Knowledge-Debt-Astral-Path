...
// learning-velocity-svc —— 学习速度建模（§19.6）
// 独立进程/容器部署（§19.11）：
...
ServiceHost.Run<LearningVelocityController>(args, "learning-velocity-svc", b => b.Services.AddAstralPathPersistence(b.Configuration));
