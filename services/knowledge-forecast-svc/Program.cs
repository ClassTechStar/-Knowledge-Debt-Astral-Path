...
// knowledge-forecast-svc —— 学业预警预测（§19.9，强伦理）
// 独立进程/容器部署（§19.11）：
...
ServiceHost.Run<KnowledgeForecastController>(args, "knowledge-forecast-svc", b => b.Services.AddAstralPathPersistence(b.Configuration));
